...
describe('+ FilesController', () => {
  ...
  describe('+ GET: /files/:id/data', () => {
    ...
    it('+ Fails if the file is not public and not requested by the owner', function () {
      return new Promise((done) => {
    ...
    it('+ Succeeds if the file is not public but requested by the owner', function () {
      return new Promise((done) => {
        request.get(`/files/${mockFiles[0].id}/data`)
          .set('X-Token', token)
          .expect(200)
    ...
    it('+ Succeeds if the file is not public but requested by the owner [alt]', function () {
      return new Promise((done) => {
